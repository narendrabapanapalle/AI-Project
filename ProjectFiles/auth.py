...
class AuthManager:
    ...
    def show_auth_page(self):
        ...
        st.set_page_config(
            page_title="AI Legal Reference and Case Retrieval System - Login",
            page_icon="⚖️",
            layout="wide"
        )
        ...
        st.markdown("""
            <div class="main-title">
                ⚖️AI Legal Reference and Case Retrieval System
            </div>
        ...
        with col_img:
            ...
            # Try to load the legal_photo.jpg
            if os.path.exists("legal_photo.jpg"):
                try:
                # --- CHANGE: Using HTML to control both width and height ---
                    import base64
                    with open("legal_photo.jpg", "rb") as img_file:
                    ...
                    st.markdown("""
                        ...
                        ">
                            <div style="text-align: center; color: white;">
                                <h3>⚖️ Legal System</h3>
                                <p>Place your legal_photo.jpg here</p>
                            </div>
                        </div>
                    """, unsafe_allow_html=True)
            else:
