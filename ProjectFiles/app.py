...
def show_user_profile_sidebar():
    ...
    st.markdown("**AI Legal Reference and Case Retrieval System** is your AI-powered legal research assistant. Ask any legal question and get comprehensive answers with proper citations.")

def show_legalbot_interface():
    """Show the main LegalBot interface"""
    st.set_page_config(
        page_title=" AI Legal Reference and Case Retrieval System",
        page_icon="⚖️",
        layout="wide"
    )
    ...
    if st.session_state.get("show_profile", False):
        ...
        with col2:
            st.title("⚖️ AI Legal Reference and Case Retrieval System- Profile")
        ...
        st.markdown("""
            <div style="text-align: center; padding: 2rem 0; color: white;">
                <h1 style="font-size: 3em; margin-bottom: 0;">⚖️ AI Legal Reference and Case Retrieval System</h1>
                <p style="font-size: 1.2em; opacity: 0.8;">Your AI Legal Research Assistant</p>
            </div>
        """, unsafe_allow_html=True)
        ...
        if session_id:
            ...
            if hasattr(history, 'messages') and history.messages:
                ...
                with st.chat_message("assistant", avatar="⚖️"):
                    st.markdown("Hi, I'm LegalBot. Ask me any legal research question.")
            
            # Handle new user input
            if prompt := st.chat_input("What legal question can I help you with?"):
